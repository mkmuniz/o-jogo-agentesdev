...
export default function WarnSection() {
    return <>
        <div className="bg-header relative h-screen w-full font-spacemono flex flex-col items-center justify-center overflow-hidden">
            <div className="flex flex-col justify-center items-center space-y-2 line-clamp-1">
            ...
            <div className="z-0 absolute inset-x-[11%] inset-y-[21%] w-4/5 h-[76%] rounded-3xl bg-black transition duration-200 ease-out transform translate-x-1 translate-y-1 border-white border-x border-y group-hover:-translate-x-0 group-hover:-translate-y-0">
            </div>
        </div>
    </>
};